...
import com.example.week05.jwt.filter.JwtFilter;
import com.example.week05.jwt.provider.JwtProvider;
...
@Configuration //이 클래스를 실행하게금 메모리에 올려준다.
    ...
    private final JwtProvider jwtProvider;
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .sessionManagement()
                    .sessionCreationPolicy(SessionCreationPolicy.STATELESS) //session방식은 사용하지 않지만 session공간만 사용한다.
